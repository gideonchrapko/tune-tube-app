  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <div className={`flex flex-col w-full transition-all duration-300 ${isSidebarOpen ? 'pl-64' : 'pl-16'}`}>
        {/* Header Section */}
        <div className="flex items-center h-[105px] px-8 py-6 bg-[#f0f4f7]">
          <div>
            <p className="font-bold text-black text-2xl">Welcome,</p>
            <p className="text-black text-xl">MurphsLife</p>
          </div>
        </div>

        {/* First Section with two wide rectangles */}
